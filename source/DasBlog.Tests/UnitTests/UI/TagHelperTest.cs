...
namespace DasBlog.Tests.UnitTests.UI
{
	public class TagHelperTest
	{
		...
		public static TheoryData<TagHelper, string> DasBlogPostLinkTagHelperData = new TheoryData<TagHelper, string>
		{
			...
			{new CommentPostTagHelper(new DasBlogSettingTest()) { Post = new PostViewModel(){ PermaLink = "some-blog-post", EntryId = "0B74C9D3-4D2C-4754-B607-F3847183221C" }}, "/post/some-blog-post/comments" }
		};
	}
}
