...
namespace newtelligence.DasBlog.Util.Zip
{
    ...
    public class ZipDirEntry
    {
        ...
        public static ZipDirEntry Read(System.IO.Stream s, bool TurnOnDebug)
        {
            ...
            zde._LastModified = newtelligence.DasBlog.Util.Zip.Shared.PackedToDateTime(zde._LastModDateTime);
            ...
            zde._FileName = newtelligence.DasBlog.Util.Zip.Shared.StringFromBuffer(block, 0, block.Length);
            ...
            n = s.Read(block, 0, block.Length);
            zde._Comment = newtelligence.DasBlog.Util.Zip.Shared.StringFromBuffer(block, 0, block.Length);
