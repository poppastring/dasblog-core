...
<%@ Control language="c#" Codebehind="ClickThroughsBox.ascx.cs" AutoEventWireup="True" Inherits="newtelligence.DasBlog.Web.ClickThroughsBox" %>
...
<div class="bodyContentStyle">
	<div class="pageTopic">
		<asp:Label id=Label1 runat="server" Text='<%# newtelligence.DasBlog.Web.ApplicationResourceTable.Get().GetString("text_clickthrough_title") %>'>
		</asp:Label>
