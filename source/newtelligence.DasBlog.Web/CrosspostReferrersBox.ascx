...
<%@ Control language="c#" Codebehind="CrosspostReferrersBox.ascx.cs" AutoEventWireup="True" Inherits="newtelligence.DasBlog.Web.CrosspostReferrersBox" %>
...
<div class="bodyContentStyle">
	<div class="pageTopic">
		<asp:Label id=Label1 runat="server" Text='<%# newtelligence.DasBlog.Web.ApplicationResourceTable.Get().GetString("text_crosspost_referrer_title") %>'>
		</asp:Label>
