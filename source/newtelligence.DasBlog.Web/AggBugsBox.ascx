...
<%@ Control language="c#" Codebehind="AggBugsBox.ascx.cs" AutoEventWireup="True" Inherits="newtelligence.DasBlog.Web.AggBugsBox" %>
...
<div class="bodyContentStyle">
	<div class="pageTopic">
		<asp:Label id=Label1 runat="server" Text='<%# newtelligence.DasBlog.Web.ApplicationResourceTable.Get().GetString("text_aggbug_title") %>'>
		</asp:Label>
