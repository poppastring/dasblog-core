...
namespace DasBlog.Web.TagHelpers.Post
{
	public class PostDeleteLinkTagHelper : TagHelper
	{
		...
		public override void Process(TagHelperContext context, TagHelperOutput output)
		{
			...
			output.Attributes.SetAttribute("class", "btn btn-sm btn-outline-danger");
			...
			output.Content.SetHtmlContent("<i class=\"fa-regular fa-trash-can me-1\" aria-hidden=\"true\"></i>Delete this post");
