	...
	public class TimeZoneIndexViewModel
	{
		...
		public List<TimeZoneIndexViewModel> Init()
		{
			return new List<TimeZoneIndexViewModel>() {
				...
				new TimeZoneIndexViewModel { Id = -10, Name = "Hawaii–Aleutian (-10)" },
				...
				new TimeZoneIndexViewModel { Id = -1, Name = "Cape Verde (-1)" },
				new TimeZoneIndexViewModel { Id = -0, Name = "UTC (+0)" },
				new TimeZoneIndexViewModel { Id = 1, Name = "West Africa, Central Europe(+1)" },
				...
				new TimeZoneIndexViewModel { Id = 8, Name = "Hong Kong, Singapore (+8)" },
				new TimeZoneIndexViewModel { Id = 9, Name = "Japan, South/North Korea (+9)" },
